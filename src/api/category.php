...
//sql query
$sql = "SELECT * from products LEFT JOIN productImage on products.productId = productImage.productId WHERE products.categoryId = '$id'
UNION 
SELECT * from products
RIGHT JOIN productImage on products.productId = productImage.productId WHERE products.categoryId = '$id'";
